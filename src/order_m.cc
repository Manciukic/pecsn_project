...
void Order::setVip(bool vip)
{
    this->vip = vip;
}

bool Order::getCompound() const
{
    return this->compound;
}

void Order::setCompound(bool compound)
{
    this->compound = compound;
}

::omnetpp::simtime_t Order::getCreationTime() const
{
...
OrderDescriptor::OrderDescriptor() : omnetpp::cClassDescriptor("Order", "omnetpp::cMessage")
{
