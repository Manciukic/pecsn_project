...
\begin{figure}[H]
  \begin{minipage}{0.48\textwidth}
    ...
    \caption{Both Vip and Normal response time at the cashier by varying total Arrival Rate($\lambda_N={{0.1..1.1 \text{ step } 0.1}},\lambda_V=0.3*\lambda_N,\pi_C=0.2, \mu_K=0.45, \mu_C=1.5$).} 
    \label{}
  \end{minipage}\hspace{0.03\textwidth}
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/workloadCompound.png}
    \caption{Both Vip and Normal response time at the kitchen by varying total Arrival Rate($\lambda_N={{0.1..1.1 \text{ step } 0.1}},\lambda_V=0.3*\lambda_N,\pi_C=0.2, \mu_K=0.45, \mu_C=1.5$).}
    \label{}
  \end{minipage}
\end{figure}
