...
It's also interesting to visualize how much, in terms of Response Time, the service offered to customers improve or not compared to the Fifo scenario. This is done by computing the difference between the Response Times got from the experiments and the theoretical Fifo response time ($\frac{1}{\mu_C-\lambda}$).
